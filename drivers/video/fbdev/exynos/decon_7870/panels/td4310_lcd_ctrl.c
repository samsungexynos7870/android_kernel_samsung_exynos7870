...
#include "mdnie.h"
#include "mdnie_lite_table_on7xe_td4310.h"
#endif
...
#define TD4310_ID_REG			0xDA	/* LCD ID1,ID2,ID3 */
#define TD4310_ID_LEN			3
...
static int dsim_read_hl_data(struct lcd_info *lcd, u8 addr, u32 size, u8 *buf)
{
	...
	DSI_WRITE_G(SEQ_TD4310_B0, ARRAY_SIZE(SEQ_TD4310_B0));
try_read:
...
static int td4310_read_init_info(struct lcd_info *lcd)
{
...
static int td4310_read_id(struct lcd_info *lcd)
{
	struct panel_private *priv = &lcd->dsim->priv;
	int i, ret = 0;
	struct decon_device *decon = get_decon_drvdata(0);
	static char *LDI_BIT_DESC_ID[BITS_PER_BYTE * TD4310_ID_LEN] = {
		[0 ... 23] = "ID Read Fail",
	};
	...
	for (i = 0; i < TD4310_ID_LEN; i++) {
		ret = dsim_read_hl_data(lcd, TD4310_ID_REG + i, 1, &lcd->id_info.id[i]);
		if (ret < 0)
			break;
	}
	...
	if (ret < 0 || !lcd->id_info.value) {
		...
		if (!lcdtype && decon)
			decon_abd_save_bit(&decon->abd, BITS_PER_BYTE * TD4310_ID_LEN, cpu_to_be32(lcd->id_info.value), LDI_BIT_DESC_ID);
	}
...
static int td4310_displayon_late(struct lcd_info *lcd)
{
	int ret = 0;
	...
	DSI_WRITE(SEQ_TD4310_BLON, ARRAY_SIZE(SEQ_TD4310_BLON));

	return ret;
}

static int td4310_exit(struct lcd_info *lcd)
{
	int ret = 0;
...
static int td4310_init(struct lcd_info *lcd)
{
	int ret = 0;
	...
	DSI_WRITE_G(SEQ_TD4310_B0, ARRAY_SIZE(SEQ_TD4310_B0));
	DSI_WRITE_G(SEQ_TD4310_B3, ARRAY_SIZE(SEQ_TD4310_B3));
	DSI_WRITE_G(SEQ_TD4310_B4, ARRAY_SIZE(SEQ_TD4310_B4));
	DSI_WRITE_G(SEQ_TD4310_B6, ARRAY_SIZE(SEQ_TD4310_B6));
	DSI_WRITE_G(SEQ_TD4310_B8, ARRAY_SIZE(SEQ_TD4310_B8));
	DSI_WRITE_G(SEQ_TD4310_B9, ARRAY_SIZE(SEQ_TD4310_B9));
	DSI_WRITE_G(SEQ_TD4310_BA, ARRAY_SIZE(SEQ_TD4310_BA));
	DSI_WRITE_G(SEQ_TD4310_BB, ARRAY_SIZE(SEQ_TD4310_BB));
	DSI_WRITE_G(SEQ_TD4310_BC, ARRAY_SIZE(SEQ_TD4310_BC));
	DSI_WRITE_G(SEQ_TD4310_BD, ARRAY_SIZE(SEQ_TD4310_BD));
	DSI_WRITE_G(SEQ_TD4310_BE, ARRAY_SIZE(SEQ_TD4310_BE));
	DSI_WRITE_G(SEQ_TD4310_C0, ARRAY_SIZE(SEQ_TD4310_C0));
	DSI_WRITE_G(SEQ_TD4310_C1, ARRAY_SIZE(SEQ_TD4310_C1));
	DSI_WRITE_G(SEQ_TD4310_C2, ARRAY_SIZE(SEQ_TD4310_C2));
	DSI_WRITE_G(SEQ_TD4310_C3, ARRAY_SIZE(SEQ_TD4310_C3));
	DSI_WRITE_G(SEQ_TD4310_C4, ARRAY_SIZE(SEQ_TD4310_C4));
	DSI_WRITE_G(SEQ_TD4310_C5, ARRAY_SIZE(SEQ_TD4310_C5));
	DSI_WRITE_G(SEQ_TD4310_C6, ARRAY_SIZE(SEQ_TD4310_C6));
	DSI_WRITE_G(SEQ_TD4310_C7, ARRAY_SIZE(SEQ_TD4310_C7));
	DSI_WRITE_G(SEQ_TD4310_C8, ARRAY_SIZE(SEQ_TD4310_C8));
	DSI_WRITE_G(SEQ_TD4310_C9, ARRAY_SIZE(SEQ_TD4310_C9));
	DSI_WRITE_G(SEQ_TD4310_CA, ARRAY_SIZE(SEQ_TD4310_CA));
	DSI_WRITE_G(SEQ_TD4310_CB, ARRAY_SIZE(SEQ_TD4310_CB));
	DSI_WRITE_G(SEQ_TD4310_CC, ARRAY_SIZE(SEQ_TD4310_CC));
	DSI_WRITE_G(SEQ_TD4310_CD, ARRAY_SIZE(SEQ_TD4310_CD));
	DSI_WRITE_G(SEQ_TD4310_CE, ARRAY_SIZE(SEQ_TD4310_CE));
	DSI_WRITE_G(SEQ_TD4310_CF, ARRAY_SIZE(SEQ_TD4310_CF));
	DSI_WRITE_G(SEQ_TD4310_D0, ARRAY_SIZE(SEQ_TD4310_D0));
	DSI_WRITE_G(SEQ_TD4310_D1, ARRAY_SIZE(SEQ_TD4310_D1));
	DSI_WRITE_G(SEQ_TD4310_D3, ARRAY_SIZE(SEQ_TD4310_D3));
	DSI_WRITE_G(SEQ_TD4310_D6, ARRAY_SIZE(SEQ_TD4310_D6));
	DSI_WRITE_G(SEQ_TD4310_D7, ARRAY_SIZE(SEQ_TD4310_D7));
	DSI_WRITE_G(SEQ_TD4310_D9, ARRAY_SIZE(SEQ_TD4310_D9));
	DSI_WRITE_G(SEQ_TD4310_DD, ARRAY_SIZE(SEQ_TD4310_DD));
	DSI_WRITE_G(SEQ_TD4310_DE, ARRAY_SIZE(SEQ_TD4310_DE));
	DSI_WRITE_G(SEQ_TD4310_EA, ARRAY_SIZE(SEQ_TD4310_EA));
	DSI_WRITE_G(SEQ_TD4310_EE, ARRAY_SIZE(SEQ_TD4310_EE));
	DSI_WRITE_G(SEQ_TD4310_F1, ARRAY_SIZE(SEQ_TD4310_F1));

	DSI_WRITE(SEQ_TD4310_CABC_OFF, ARRAY_SIZE(SEQ_TD4310_CABC_OFF));
	DSI_WRITE_G(SEQ_TD4310_BL, ARRAY_SIZE(SEQ_TD4310_BL));
	DSI_WRITE(SEQ_TD4310_CABC_MIN, ARRAY_SIZE(SEQ_TD4310_CABC_MIN));
...
static int td4310_probe(struct lcd_info *lcd)
{
	int ret = 0;
...
struct mipi_dsim_lcd_driver td4310_mipi_lcd_driver = {
	.name		= "td4310",
...
{
	if (((lcdtype & 0x00F000) >> 8) == 0x10)
		mipi_lcd_driver = &td4310_mipi_lcd_driver;

	dsim_info("%s: lcdtype: %d\n", __func__, lcdtype);
