...
static struct fimc_is_sensor_cfg config_module_2p6[] = {
	/* 4608x3456@30fps */
	FIMC_IS_SENSOR_CFG_EXT(4608, 3456, 30, 36, 0, CSI_DATA_LANES_4, 1443),
	/* 4608x2624@30fps */
	FIMC_IS_SENSOR_CFG_EXT(4608, 2624, 30, 36, 1, CSI_DATA_LANES_4, 1443),
	/* 4608x2240@30fps */
	FIMC_IS_SENSOR_CFG_EXT(4608, 2240, 30, 36, 2, CSI_DATA_LANES_4, 1443),
	/* 2304x1728@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2304, 1728, 30, 34, 3, CSI_DATA_LANES_4, 1352),
	/* 2304x1728@15fps */
	FIMC_IS_SENSOR_CFG_EXT(2304, 1728, 15, 34, 4, CSI_DATA_LANES_4, 1352),
	/* 2304x1312@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2304, 1312, 30, 34, 5, CSI_DATA_LANES_4, 1352),
	/* 2304x1120@30fps */
	FIMC_IS_SENSOR_CFG_EXT(2304, 1120, 30, 34, 6, CSI_DATA_LANES_4, 1352),
	/* 1152x864@120fps */
	FIMC_IS_SENSOR_CFG_EXT(1152, 864, 120, 34, 7, CSI_DATA_LANES_4, 1352),
	/* 1152x656@120fps */
	FIMC_IS_SENSOR_CFG_EXT(1152, 656, 120, 34, 8, CSI_DATA_LANES_4, 1352),
};

static struct fimc_is_vci vci_module_2p6[] = {
	{
		.pixelformat = V4L2_PIX_FMT_SBGGR10,
		.config = {{0, HW_FORMAT_RAW10}, {1, HW_FORMAT_USER}, {2, 0}, {3, 0} }
	}, {
