...
static void sx9306_wifi_display_data_reg(struct sx9306_p *data)
{
	...
	sx9306_wifi_i2c_write(data, SX9306_REGSENSORSELECT, data->channel_main);
...
static void sx9306_wifi_get_data(struct sx9306_p *data)
{
	...
	sx9306_wifi_i2c_write(data, SX9306_REGSENSORSELECT,
		data->channel_main);
...
#ifdef CONFIG_SENSORS_GRIP_CHK_HALLIC
	sx9306_wifi_check_hallic_state(HALLIC_PATH, data->hall_ic);
...
static int sx9306_wifi_parse_dt(struct sx9306_p *data, struct device *dev)
{
	...
	sx9306_wifi_read_setupreg(node, "sx9306_wifi-i2c,ctrl3", &setup_reg[SX9306_CTRL3_IDX].val);
	sx9306_wifi_read_setupreg(node, "sx9306_wifi-i2c,ctrl4", &setup_reg[SX9306_CTRL4_IDX].val);
	sx9306_wifi_read_setupreg(node, "sx9306_wifi-i2c,ctrl5", &setup_reg[SX9306_CTRL5_IDX].val);
	sx9306_wifi_read_setupreg(node, "sx9306_wifi-i2c,ctrl6", &setup_reg[SX9306_CTRL6_IDX].val);
	sx9306_wifi_read_setupreg(node, "sx9306_wifi-i2c,ctrl7", &setup_reg[SX9306_CTRL7_IDX].val);
	sx9306_wifi_read_setupreg(node, "sx9306_wifi-i2c,ctrl8", &setup_reg[SX9306_CTRL8_IDX].val);
	sx9306_wifi_read_setupreg(node, "sx9306_wifi-i2c,ctrl9", &setup_reg[SX9306_CTRL9_IDX].val);
	sx9306_wifi_read_setupreg(node, "sx9306_wifi-i2c,ctrl10", &setup_reg[SX9306_CTRL10_IDX].val);
