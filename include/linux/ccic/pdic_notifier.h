...
struct s2mu004_pdic_notifier_struct {
...
enum {
	S2MU004_PDIC_NOTIFY_DEV_MUIC,
	S2MU004_PDIC_NOTIFY_DEV_USB,
	S2MU004_PDIC_NOTIFY_DEV_CHARGER,
};
 ...
 */
extern void s2mu004_pdic_notifier_attach_attached_dev(muic_attached_dev_t new_dev);
extern void s2mu004_pdic_notifier_detach_attached_dev(muic_attached_dev_t cur_dev);
extern void s2mu004_pdic_notifier_logically_attach_attached_dev(muic_attached_dev_t new_dev);
extern void s2mu004_pdic_notifier_logically_detach_attached_dev(muic_attached_dev_t cur_dev);
...
extern int s2mu004_pdic_notifier_register(struct notifier_block *nb,
		notifier_fn_t notifier, muic_notifier_device_t listener);
extern int s2mu004_pdic_notifier_unregister(struct notifier_block *nb);
